...
function openSettings() {
  ...
  function sendData() {
    ...
    $.ajax({
        type: 'POST',
        url: '/PHP-MYSQL-MONGODB-REDIUS-BOOTSTRAP-AJAX-WEBSITE/php/register.php/php/profile.php', // Change this to your PHP script URL
        data: jsonString,
...
function checkUsernameInMongoDB() {
  ...
  if (username) {
      ...
      $.ajax({
          url: '/PHP-MYSQL-MONGODB-REDIUS-BOOTSTRAP-AJAX-WEBSITE/php/register.php/php/profile.php',
          type: 'GET',
